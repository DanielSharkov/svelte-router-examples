...
const config = {
    ...
    routes: {
        'home': {
            path: '/',
            lazyComponent: {
                component: async () => (await import('./Home-fdf39a6d.js')).default,
        ...
        'about': {
            path: '/about',
            lazyComponent: {
                component: async () => (await import('./About-308a1ee1.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'blogs': {
            path: '/blogs',
            lazyComponent: {
                component: async () => (await import('./Blogs-cc43dc54.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'blog': {
            path: '/blogs/:id',
            lazyComponent: {
                component: async () => (await import('./Blog-8e4b800f.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
        'router-struct': {
            path: '/_dev',
            lazyComponent: {
                component: async () => (await import('./RouterStruct-5393214d.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'lazy-load': {
            ...
            lazyComponent: {
                component: async () => {
                    ...
                    return (await import('./Lazy-3615ed84.js')).default;
                },
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
...
//# sourceMappingURL=main-a84e5ab8.js.map
