...
const config = {
    ...
    routes: {
        'login': {
            path: '/login',
            lazyComponent: {
                component: async () => (await import('./Login-be3e24ed.js')).default,
        ...
        'timeline': {
            path: '/',
            lazyComponent: {
                component: async () => (await import('./Timeline-24776738.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'users': {
            path: '/users',
            lazyComponent: {
                component: async () => (await import('./Users-9c45079f.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'profile': {
            path: '/users/:userID',
            lazyComponent: {
                component: async () => (await import('./Profile-6f7c79b0.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
        'post': {
            path: '/post/:postID',
            lazyComponent: {
                component: async () => (await import('./Post-68e9d46a.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
        'thread': {
            ...
            lazyComponent: {
                component: async () => (await import('./Thread-165654ae.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
...
//# sourceMappingURL=main-5e9304a6.js.map
