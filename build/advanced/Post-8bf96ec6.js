import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, e as element, b as attr_dev, c as add_location, f as insert_dev, l as listen_dev, x as transition_in, h as add_render_callback, u as transition_out, j as create_bidirectional_transition, k as detach_dev, n as validate_slots, o as createEventDispatcher, D as DB, p as onMount, q as defaultPageTransition, J as noop, C as create_component, E as mount_component, F as destroy_component } from './main-b04ea461.js';
import { P as Post } from './Post-db5e899a.js';
import './Thread-6b695541.js';

/* advanced/routes/Post.svelte generated by Svelte v3.52.0 */
const file = "advanced/routes/Post.svelte";
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			p = element("p");
			p.textContent = "The post you're trying to access doesn't exist.";
			attr_dev(p, "class", "text-center");
			add_location(p, file, 16, 2, 527);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 12, 0, 360);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	return [dispatch, post, params, outroend_handler];
}
...
export { Post_1 as default };
//# sourceMappingURL=Post-8bf96ec6.js.map
