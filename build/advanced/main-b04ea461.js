...
const config = {
    ...
    routes: {
        'login': {
            path: '/login',
            lazyComponent: {
                component: async () => (await import('./Login-983c6c94.js')).default,
        ...
        'timeline': {
            path: '/',
            lazyComponent: {
                component: async () => (await import('./Timeline-b76b367b.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'users': {
            path: '/users',
            lazyComponent: {
                component: async () => (await import('./Users-0c28bc70.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
            props: {
        ...
        'profile': {
            path: '/users/:userID',
            lazyComponent: {
                component: async () => (await import('./Profile-149dd70e.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
        'post': {
            path: '/post/:postID',
            lazyComponent: {
                component: async () => (await import('./Post-8bf96ec6.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
        'thread': {
            ...
            lazyComponent: {
                component: async () => (await import('./Thread-c62d2ab9.js')).default,
                loading: LoadingRoute,
                fallback: LoadingRouteFailFallback,
            },
        },
...
//# sourceMappingURL=main-b04ea461.js.map
