	...
	{#if newComment !== null}
		<div class='write-comment'>
			<button on:click={()=> newComment = null} class='discard flex flex-center'>
				<svg class='icon stroke icon-1' viewBox='0 0 120 120' fill='none' xmlns='http://www.w3.org/2000/svg'>
					<path d='M28.2998 91.5788L91.7007 27.7007M91.7002 91.5787L28.2993 27.7007' stroke-width='10' stroke-linecap='round'/>
				</svg>
			</button>
			<textarea
				rows='1'
			...
			<button on:click={submitComment} class='submit flex flex-center'>
				<svg class='icon stroke icon-1' viewBox='0 0 120 120' fill='none' xmlns='http://www.w3.org/2000/svg'>
					<path d='M18.3604 68.6396L42.103 92.3822L105.504 28.5042' stroke-width='10' stroke-linecap='round'/>
				</svg>
			</button>
		</div>
	{:else}
