...
<div class='page'>
	<button id='SvelteRouterLogoWrapper' on:click={logoClick} class:hoverable={isAnimDone}>
		<svg id='SvelteRouterLogo' fill='none' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 160 160' class:anim={!isAnimDone} class:reset>
			...
			<g class='indicator'on:animationend={animEnd} on:animationstart={animStart}>
				<path fill='#FF3E00' class='indicator-arrow' d='m80 22 7 58-7 58-7-58 7-58Z'/>
				<path fill='#fff' stroke='#FF3E00' class='indicator-nop' d='M88.5 79h-5.15a3.5 3.5 0 0 0-6.7 0H71.5a1 1 0 1 0 0 2h5.15a3.5 3.5 0 0 0 6.7 0h5.15a1 1 0 1 0 0-2Z'/>
			</g>
		</svg>
	</button>
	<h1>
...
<style>
	...
	#SvelteRouterLogoWrapper.hoverable:hover {
